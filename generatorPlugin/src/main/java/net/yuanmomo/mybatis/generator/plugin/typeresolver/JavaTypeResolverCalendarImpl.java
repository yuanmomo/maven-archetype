...
/**
 * Project Name : Tools
 * File Name    : CalendarTypeResolver.java
 * Package Name : net.yuanmomo.tools.db.orm.mybatis.generator.plugin.typeresolver
 * Created on   : 2014-2-20下午4:08:05
 * Author       : Hongbin Yuan
 * Blog         : yuanmomo.net
 * Company      : 成都逗溜网科技有限公司  
 */

package net.yuanmomo.mybatis.generator.plugin.typeresolver;
...
/**
 * ClassName : JavaTypeResolverCalendarImpl 
 * Function  : TODO ADD FUNCTION. 
 * Reason    : TODO ADD REASON. 
 * Date      : 2014-2-20 下午4:08:05 
 *
 * @author   : Hongbin Yuan
 * @version  
 * @since      JDK 1.6
...
public class JavaTypeResolverCalendarImpl implements JavaTypeResolver {
	 protected List<String> warnings;
	    ...
	    protected String jdbcDateToJavaType = null;
	    protected String jdbcTimeToJavaType = null;
	    protected String jdbcTimestampToJavaType = null;

	    protected Map<Integer, JdbcTypeInformation> typeMap;
	    
	    public JavaTypeResolverCalendarImpl() {
	        super();
	        ...
	        typeMap.put(Types.DATE, new JdbcTypeInformation("DATE", //$NON-NLS-1$
	                new FullyQualifiedJavaType(Calendar.class.getName())));
	    ...
	    public FullyQualifiedJavaType calculateJavaType(
	        ...
	        if (jdbcTypeInformation == null) {
	            ...
	            case Types.DATE:
	            		answer = new FullyQualifiedJavaType(Calendar.class.getName());
	            		break;
	            default:
	                answer = null;
	                break;
